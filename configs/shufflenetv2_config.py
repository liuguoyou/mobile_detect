...
config.TRAIN.train_set_size=14000              ###widerface train size
config.TRAIN.val_set_size=1300             ###widerface val size
...
config.MODEL.fpn_dims=[64,96,96]
...
config.MODEL.deployee='mnn'    ### None for training ,    deployee : tf (x86), mnn (android), coreml(ios)
