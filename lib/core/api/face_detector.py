...
class FaceDetector:
    ...
    def __call__(self, image, score_threshold=0.5,input_shape=(cfg.DATA.hin,cfg.DATA.win)):
        """Detect faces.
        ...
        bboxes = self.py_nms(np.array(bboxes[0]), iou_thres=0.5, score_thres=score_threshold)
