...
from lib.core.model.ssd import mobile_ssd
...
class trainner():
    ...
    def tower_loss(self,scope, images, labels,boxes,L2_reg, training):
        ...
        if cfg.MODEL.deployee:
            reg_loss,cla_loss=ssd.forward(images,boxes,labels, L2_reg, False)
        else:
                            ...
                            with slim.arg_scope([slim.model_variable, slim.variable], device='/cpu:0'):
                                if cfg.MODEL.deployee:
                                    ...
                                    images_ = tf.placeholder(tf.float32, [None, cfg.DATA.hin, cfg.DATA.win, cfg.DATA.channel],
                                                             name="images")
                                # images_ = tf.placeholder(tf.float32, [None, None,None, 1],
                                #                          name="images")
