...
V3_SMALL_FOR_LIGHT_FACE = dict(
    defaults=dict(DEFAULTS),
    spec=([
        # stage 1，

        ##
        op(slim.conv2d, stride=2, num_outputs=4, kernel_size=(3, 3)),
        op(slim.separable_conv2d, stride=2, num_outputs=8, kernel_size=(3, 3)),
        mbv3_op(ef=1, n=8, k=3, s=2),
        mbv3_op(ef=72. / 16, n=16, k=3, s=2),
        mbv3_op(ef=(88. / 24), n=24, k=3, s=1),
        mbv3_op(ef=2, n=24, k=3, s=2),
        mbv3_op(ef=4, n=24, k=3, s=1),
        mbv3_op(ef=2, n=24, k=3, s=1),
        # mbv3_op(ef=2, n=32, k=3, s=1),
        mbv3_op(ef=2, n=48, k=3, s=2),
        mbv3_op(ef=4, n=48, k=3, s=1),
        mbv3_op(ef=2, n=48, k=3, s=1),
        # mbv3_op(ef=2, n=48, k=3, s=1),
        # op(slim.conv2d, stride=1, kernel_size=[1, 1], num_outputs=576),
        # op(reduce_to_1x1, default_size=7, stride=1, padding='VALID'),
        # op(slim.conv2d,
...
small_lightface = wrapped_partial(mobilenet, conv_defs=V3_SMALL_FOR_LIGHT_FACE)
